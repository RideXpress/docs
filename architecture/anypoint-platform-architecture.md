...
- [3. Security Architecture](#3-security-architecture)
    ...
    - [3.2. Anypoint User Access Management - Authentication](#32-anypoint-user-access-management-authentication)
    - [3.3. Anypoint User Access Management – Authorization](#33-anypoint-user-access-management-authorization)
    - [3.4. Anypoint Teams – Structure and Considerations](#34-anypoint-teams-structure-and-considerations)
    - [3.5. Platform User Access Management](#35-platform-user-access-management)
    - [3.6. User Audit](#36-user-audit)
    - [3.7. API and Application Security](#37-api-and-application-security)
    - [3.8. API Client Authentication and Authorization](#38-api-client-authentication-and-authorization)
    - [3.9. Secure Connectivity](#39-secure-connectivity)
    - [3.10. API Policy Management](#310-api-policy-management)
    - [3.11. Secure Application Configuration Management](#311-secure-application-configuration-management)
    - [3.12. Infrastructure Security](#312-infrastructure-security)
    - [3.13. Firewall Rules](#313-firewall-rules)
...
- [6. Common Services](#6-common-services)
...
- [7. Software Development Lifecycle (SDLC)](anypoint-platform-architecture/7-software-development-lifecycle.md)
    ...
    - [7.4. Development Standards and Naming Conventions](anypoint-platform-architecture/7-software-development-lifecycle.md#74-development-standards-and-naming-conventions)
        - [7.4.1 Maven Artifact Id](anypoint-platform-architecture/7-software-development-lifecycle.md#741-maven-artifact-id)
        - [7.4.2 Cloudhub domain](anypoint-platform-architecture/7-software-development-lifecycle.md#742-cloudhub-domain)
        - [7.4.3 API version](anypoint-platform-architecture/7-software-development-lifecycle.md#743-api-version)
        - [7.4.4 API Resources organization](anypoint-platform-architecture/7-software-development-lifecycle.md#744-api-resources-organization)
        - [7.4.5 API Methods](anypoint-platform-architecture/7-software-development-lifecycle.md#745-api-methods)
        - [7.4.6 API body format](anypoint-platform-architecture/7-software-development-lifecycle.md#746-api-body-format)
        - [7.4.7 API pagination and filtering](anypoint-platform-architecture/7-software-development-lifecycle.md#747-api-pagination-and-filtering)
        - [7.4.8 Files names](anypoint-platform-architecture/7-software-development-lifecycle.md#748-files-names)
        - [7.4.9 Flow names](anypoint-platform-architecture/7-software-development-lifecycle.md#749-flow-names)
        - [7.4.10 Dataweave files](anypoint-platform-architecture/7-software-development-lifecycle.md#7410-dataweave-files)
        - [7.4.11 Connector configuration names](anypoint-platform-architecture/7-software-development-lifecycle.md#7411-connector-configuration-names)
        - [7.4.12 Log files](anypoint-platform-architecture/7-software-development-lifecycle.md#7412-log-files)
        - [7.4.13 API, Maven and Cloudhub matching](anypoint-platform-architecture/7-software-development-lifecycle.md#7413-api-maven-and-cloudhub-matching) 
